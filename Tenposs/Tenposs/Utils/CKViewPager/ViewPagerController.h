...
@property(nonatomic) BOOL shouldShowdividerAtFirstItem;
@property(nonatomic) BOOL shouldShowdividerAllItem;
@property(nonatomic) BOOL shouldEqualWidth;
@property(nonatomic) ActionBlock shouldShowMoreItem;
@property(nonatomic) NSInteger  shouldHideTabFromIndex;
