...
-(void)highlightLinkAtRange:(NSRange)range{
    NSMutableAttributedString *mas = [[NSMutableAttributedString alloc] initWithAttributedString:self.attributedText];
    NSDictionary *linkAttributes = @{ NSForegroundColorAttributeName :[UIColor colorWithRed:31/255.0 green:192/255.0 blue:186/255.0 alpha:1.0],
                                      NSUnderlineStyleAttributeName : @(NSUnderlineStyleSingle),NSFontAttributeName:[UIFont fontWithName:@"Avenir Next Demi Bold" size:13] };
    [mas addAttributes:linkAttributes range:range];
