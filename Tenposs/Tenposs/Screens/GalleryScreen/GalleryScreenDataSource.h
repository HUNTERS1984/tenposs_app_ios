...
#define GalleryScreenError_isLast    @"this is last category"
#define GalleryScreenError_isFirst    @"this is first category"
#define GalleryScreenError_duplicate    @"duplicate category"
