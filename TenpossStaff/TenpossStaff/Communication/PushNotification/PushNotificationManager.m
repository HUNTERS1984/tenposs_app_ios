...
- (void)PushStaffSetPushKey:(NSString *)key WithCompleteBlock:(void (^)(BOOL isSuccess, NSDictionary *resultData))completeBlock{
    _request_url = [NSString stringWithFormat:@"%@%@",PUSH_BASE_ADDRESS,PUSH_STAFF_SETPUSHKEY];
